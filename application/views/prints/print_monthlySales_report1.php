                ...
                <table border="1" bordercolor="#666666" width="100%" cellpadding="4" style="border-collapse:collapse">
                  ...
                  <tbody>
                    ...
                    if(!empty($all_report)){
                     ...
                     ?>
                     <!-- <tr>
                       <td colspan="7" align="right"><b>Total shipping = RM <?php echo number_format($t_ship,2) ?></b></td>
                     </tr> -->
                     <tr>
                       <td colspan="7" align="right"><b>Total sales = RM <?php echo number_format($total_grand,2) ?></b></td>
                     </tr>
                  </tbody>
              </table>
        </div>
