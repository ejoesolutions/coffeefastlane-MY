...
<?php
  if(!empty($all_report)){
    //echo '<b>Total Shipping '.$data_seller['shop_name'].' '.$b.' '.$t.' = RM '.number_format($t_ship,2).'</b>';
    echo '<br><b>Total monthly sales '.$data_seller['shop_name'].' '.$b.' '.$t.' = RM '.number_format($total_grand,2).'</b>';
  }
?>
