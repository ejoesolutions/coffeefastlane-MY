...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <!-- <link type="text/css" rel="stylesheet" href="<?php echo base_url('assets'); ?>/layouts/login_style/loginstyle.css" /> -->
  <!-- <link href="<?php echo base_url('assets'); ?>/layouts/login_style/styles/layout.css" rel="stylesheet" type="text/css" media="all"> -->
...
<body>
  ...
  ?>
	...
	<!-- jQuery Plugins -->
	 <script src="<?php echo base_url('assets'); ?>/layouts/layout_shop/js/jquery.min.js"></script>
	<script src="<?php echo base_url('assets'); ?>/layouts/layout_shop/js/bootstrap.min.js"></script>
