<div class="row">
  ...
  <div class="col-md-6">
    <div class="product-body">
      ...
      <br>
      <p><strong class="primary-color">Shop Name:</strong><a href="<?php echo base_url('') ?><?php echo $p_detail['shop_url'] ?>" style="color:#F7F9F9;"> <?php echo $p_detail['shop_name'] ?></a></p>
      ...
      <div class="tab-content">
        <div id="tab1" class="tab-pane fade in active">
          ...
          <p style="color:#F7F9F9;"><?php echo 'Berat :';  ?>
            ...
            <p>
            <span style="color:#F7F9F9;white-space: pre-wrap;word-wrap: break-word;"><?php echo $p_detail['description']; ?></span>
          </p>
        </div>
