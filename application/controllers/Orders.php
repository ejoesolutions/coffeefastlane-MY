      ...
      if ($_GET['status_id'] != 1) {
        ...
        $this->session->set_flashdata('upload', "
          <div class='alert alert-warning' style='color: black;background-color: #F7DC6F;border-color: #F1C40F;'>
            Your payment for order <b>#".$_GET['order_id']."</b> is unsuccessful. Please try again <a href='https://toyyibpay.com/".$_GET['billcode']."' class='text-info'>Try Again Here</a>
          </div>
        ");
